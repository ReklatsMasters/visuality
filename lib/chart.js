...
import { FFT } from './waveform';

const DATA_LENGTH = FFT / 2;
const DRAW_DATA_LENGTH = ~~(DATA_LENGTH / 2) - 1;
...
export class LineChart {
  ...
  constructor(container, {width = 500, height = 250}) {
  ...
  draw(data) {
    ...
    var hFreqData = data.slice(0, DRAW_DATA_LENGTH);
...
export class ColumnChart {
  ...
  constructor(container, {width = 500, height = 250}) {
    ...
    var columns = Array.apply(null, new Array( DRAW_DATA_LENGTH )).map((x, i) => i);
